...
# %%
def load_RL_model_if_exists(model, samples, epoch, beta, beta_decay, lr, save_path='N50_Seq_Bucket_Util1_9Layers/'):
...
class SeqRLModel(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.fc_out = nn.Linear(16, output_size)
...
# Training loop using REINFORCE with model saving
def train_RL_model(model, optimizer, training_data, num_epochs, lr, beta, beta_decay, save_interval=100, save_path='N50_Seq_Bucket_Util1_9Layers/'):
