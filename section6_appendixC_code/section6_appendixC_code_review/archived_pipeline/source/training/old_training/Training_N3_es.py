...
# %%
def load_RL_model_if_exists(model, samples, epoch, beta, beta_decay, lr, save_path='models_init/'):
...
class UtilityMaximizingRLModel(nn.Module):
    ...
    def _initialize_weights(self):
        ...
        self.fc3.bias.data.fill_(5.0)  # Bias initialization for sigmoid output
...
def train_ES(model, training_data, num_generations=100, sigma=0.1, alpha=0.01, population_size=10, save_interval=10, save_path='models_init_augr/'):
    """
