...
def train_ES(model, training_data, num_generations=100, sigma=0.1, alpha=0.01, population_size=10, save_interval=10, save_path='models_es2/'):
    """
    ...
    for generation in tqdm(range(start_generation, num_generations)):
        ...
        print(f"Generation {generation + 1}: Average Reward = {mean_reward:.4f}", flush=True)
